...
- [thecatfix/MacAI](https://github.com/thecatfix/MacAI): A fork of Anthropic Computer Use that you can run on Mac computers to give Claude and other AI models autonomous access to your computer.
